...
.logo-cell { background:var(--bg); aspect-ratio:1; display:flex; align-items:center; justify-content:center; font-family:var(--serif); font-weight:500; font-style:italic; font-size:clamp(15px,1.4vw,22px); color:var(--text); opacity:.34; transition:opacity .25s,background .25s; }
...
.print-thumb { width:100%; aspect-ratio:5/4; border-radius:4px; overflow:hidden; border:1px solid var(--line); background:var(--bg-2); position:relative; }
...
const LOGO_NAMES = ["Aukera","Bhadra","Veer","Nira","Forma","Kove","Saaj","Mira","Atlas","Orbit","Pulp","Hue"]
